<template>
  <div class="flex w-full flex-col gap-1">
    <label class="flex gap-1.5 font-medium uppercase"
      >{{ label }}
      <AsteriskIcon size="12" class="text-red-600" />
    </label>
    <textarea
      :rows="rows"
      ...
      :class="[
        `resize-none border-b border-solid bg-transparent p-2.5 outline-none`,
        error
          ? 'resize-none border-red-600 border-opacity-100 dark:border-opacity-100'
